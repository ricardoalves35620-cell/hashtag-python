    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
      ...
      <div style={{
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 12, color: '#9a3030', marginTop: 3 }}>
      ...
      <div style={{
        ...
        {explanation.badCode && (
          <div>
            <div style={{ fontSize: 11, color: '#9a3030', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: 6 }}>
              {lang === 'en' ? '⚠️ Problematic line' : '⚠️ Linha problemática'}
            </div>
            <div style={{
              background: '#0d0d0d', borderRadius: 6, padding: '8px 12px',
              fontFamily: "'JetBrains Mono', monospace", fontSize: 13,
              color: '#f48771', border: '1px solid #3a1a1a',
            }}>
              {explanation.badCode}
            </div>
          </div>
        ...
        <div>
          ...
          <p style={{ fontSize: 13, color: '#d4a0a0', lineHeight: 1.6, margin: 0 }}>
            {explanation.why[lang]}
          </p>
        </div>

        {/* How to fix */}
        <div style={{ background: '#0a1f0a', border: '1px solid #1a4a1a', borderRadius: 8, padding: 12 }}>
          <div style={{ fontSize: 11, color: '#4ade80', fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: 8 }}>
            ✅ {t.fix}
          </div>
          <pre style={{
        ...
        <button
          ...
          style={{
            ...
            color: '#9a3030', fontSize: 12, cursor: 'pointer',
