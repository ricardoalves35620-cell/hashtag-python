  ...
  exercises: [
    {
      ...
      description: {
        en: 'Goal:\nExplore how seven arithmetic operators behave when they use the same starting number.\n\nProgram requirements\n\n1. Predict\n- For the starting value 17, predict the result of addition, subtraction, multiplication, regular division, floor division, remainder and exponentiation.\n\n2. Run and compare\n- Run the completed code and compare every result with your prediction.\n- Pay special attention to the difference between regular division, floor division and remainder.\n\n3. Test a change\n- Change the starting value from 17 to 20, predict all seven results again, and rerun the program.',
        pt: 'Objetivo:\nExplore como sete operadores aritméticos se comportam usando o mesmo número inicial.\n\nRequisitos do programa\n\n1. Prever\n- Para o valor inicial 17, preveja os resultados de adição, subtração, multiplicação, divisão comum, divisão inteira, resto e potência.\n\n2. Executar e comparar\n- Execute o código completo e compare cada resultado com sua previsão.\n- Observe especialmente a diferença entre divisão comum, divisão inteira e resto.\n\n3. Testar uma mudança\n- Troque o valor inicial de 17 para 20, faça novas previsões e execute novamente.'
      },
      starterCode: `n = 17
print(n, "+ 5 =", n + 5)
print(n, "- 5 =", n - 5)
...
print("Final refund:", refund)`,
    ...
    },
    {
      ...
      description: {
        en: 'Goal:\nCreate a yearly budget report for a music school with a total budget of 48,000 dollars.\n\nProgram requirements\n\n1. Calculate\n- Allocate 30% to materials, 45% to teachers, 15% to equipment and 10% to administration.\n- Add the four allocations to verify that they equal the original budget.\n\n2. Display\n- Show the amount assigned to each category.\n- Show the final total check.\n\nExample result:\nMaterials: 14400.0\nTeachers: 21600.0\nEquipment: 7200.0\nAdmin: 4800.0\nTotal check: 48000.0',
        pt: 'Objetivo:\nCrie um relatório de orçamento anual para uma escola de música com orçamento total de 48.000 reais.\n\nRequisitos do programa\n\n1. Calcular\n- Separe 30% para materiais, 45% para professores, 15% para equipamentos e 10% para administração.\n- Some as quatro partes para confirmar que correspondem ao orçamento original.\n\n2. Mostrar\n- Mostre o valor destinado a cada categoria.\n- Mostre a conferência final do total.\n\nExemplo de resultado:\nMaterials: 14400.0\nTeachers: 21600.0\nEquipment: 7200.0\nAdmin: 4800.0\nTotal check: 48000.0'
      },
  ...
  exercises: [
    {
      ...
      description: {
        en: 'Goal:\nRun a completed accumulator and observe how one variable stores a changing total.\n\nProgram requirements\n\n1. Run and trace\n- Follow the total from its starting value through purchases of 960, 1,275 and 800.\n- After each update, connect the new displayed total to the previous total.\n\n2. Extend the sequence\n- Add one more purchase worth 500 after the existing purchases.\n- Display the new running total with the label for tiles.\n\n3. Verify\n- Predict the final total before running the modified program.',
        pt: 'Objetivo:\nExecute um acumulador completo e observe como uma variável guarda um total que muda.\n\nRequisitos do programa\n\n1. Executar e acompanhar\n- Acompanhe o total desde o valor inicial pelas compras de 960, 1.275 e 800.\n- Depois de cada atualização, relacione o novo total com o total anterior.\n\n2. Ampliar a sequência\n- Adicione mais uma compra no valor de 500 após as compras existentes.\n- Mostre o novo total acumulado com o rótulo de pisos.\n\n3. Conferir\n- Preveja o total final antes de executar o programa modificado.'
      },
      starterCode: `total = 0
print("Start:", total)
...
print("After paint:", total)`,
    ...
    },
    {
      ...
      description: {
        en: 'Goal:\nComplete a client record and its annual fee calculation by replacing four blanks.\n\nProgram requirements\n\n1. Fill the client data\n- Blank 1 is a client name stored as text.\n- Blank 2 is a whole-number age.\n- Blank 3 is a Boolean showing whether the plan is active.\n\n2. Complete the calculation\n- Blank 4 is the operator that converts the monthly fee of 450 into a 12-month annual fee.\n\n3. Display\n- Show the client name and age, the annual fee and the active status.\n\nExample result:\nClient: {{your name}}, age {{your age}}\nAnnual: 5400\nActive: True',
        pt: 'Objetivo:\nComplete um cadastro de cliente e o cálculo da taxa anual substituindo quatro lacunas.\n\nRequisitos do programa\n\n1. Preencher os dados do cliente\n- A lacuna 1 é o nome do cliente como texto.\n- A lacuna 2 é a idade como número inteiro.\n- A lacuna 3 é um valor Booleano que informa se o plano está ativo.\n\n2. Completar o cálculo\n- A lacuna 4 é o operador que transforma a mensalidade de 450 em uma taxa anual de 12 meses.\n\n3. Mostrar\n- Mostre o nome e a idade do cliente, a taxa anual e o status do plano.\n\nExemplo de resultado:\nClient: {{seu nome}}, age {{sua idade}}\nAnnual: 5400\nActive: True'
      },
...
print(f"Active: {plan_active}")`,
    ...
    },
    {
      ...
      description: {
        en: 'Goal:\nCreate a three-day courier earnings tracker that keeps a running total.\n\nProgram requirements\n\n1. Set up\n- Begin the running total at zero.\n\n2. Update the total\n- Add earnings of 120 for Monday, 95 for Tuesday and 140 for Wednesday in that order.\n- After each day, show the total earned so far.\n\n3. Display the result\n- Show the final three-day total with a currency symbol.\n\nExample result:\nAfter Monday: 120\nAfter Tuesday: 215\nAfter Wednesday: 355\n3-day total: $355',
        pt: 'Objetivo:\nCrie um controle de ganhos de entregador por três dias que mantenha um total acumulado.\n\nRequisitos do programa\n\n1. Preparar\n- Comece o total acumulado em zero.\n\n2. Atualizar o total\n- Adicione ganhos de 120 na segunda-feira, 95 na terça-feira e 140 na quarta-feira, nessa ordem.\n- Depois de cada dia, mostre o total ganho até aquele momento.\n\n3. Mostrar o resultado\n- Mostre o total final dos três dias com um símbolo de moeda.\n\nExemplo de resultado:\nApós segunda: 120\nApós terça: 215\nApós quarta: 355\nTotal 3 dias: R$355'
      },
  ...
  exercises: [
    {
      ...
      description: {
        en: 'Goal:\nRun a completed input program and compare a value before and after numeric conversion.\n\nProgram requirements\n\n1. First run\n- Enter 25 when prompted.\n- Compare the raw value and type with the converted value and type.\n- Confirm that the converted value can be used in a multiplication.\n\n2. Second run\n- Enter 40 and verify how the final calculation changes.\n\n3. Test a change\n- Change only the final multiplier from 2 to 3.\n- Enter 10, predict the result, and run again.',
        pt: 'Objetivo:\nExecute um programa de entrada completo e compare um valor antes e depois da conversão numérica.\n\nRequisitos do programa\n\n1. Primeira execução\n- Digite 25 quando solicitado.\n- Compare o valor e o tipo originais com o valor e o tipo convertidos.\n- Confirme que o valor convertido pode ser usado em uma multiplicação.\n\n2. Segunda execução\n- Digite 40 e confira como o cálculo final muda.\n\n3. Testar uma mudança\n- Altere somente o multiplicador final de 2 para 3.\n- Digite 10, preveja o resultado e execute novamente.'
      },
...
print("Math now works:", converted * 2)`,
    ...
    },
    {
      ...
      description: {
        en: 'Goal:\nComplete four user inputs by choosing the correct data type for each blank.\n\nProgram requirements\n\n1. Gather input\n- Blank 1 keeps the name as text.\n- Blank 2 converts the age to a whole number because the program calculates next year.\n- Blank 3 converts the height to a decimal number.\n- The phone number remains text because it may contain punctuation.\n\n2. Display\n- Show the name, current age, height, next-year age and phone number.\n\nExample result:\nMaria, 35 years, 1.68m\nNext year: 36\nPhone: 555-1234',
        pt: 'Objetivo:\nComplete quatro entradas do usuário escolhendo o tipo de dado correto para cada lacuna.\n\nRequisitos do programa\n\n1. Receber os dados\n- A lacuna 1 mantém o nome como texto.\n- A lacuna 2 converte a idade para número inteiro porque o programa calcula o próximo ano.\n- A lacuna 3 converte a altura para número decimal.\n- O telefone permanece como texto porque pode conter sinais de pontuação.\n\n2. Mostrar\n- Mostre o nome, a idade atual, a altura, a idade no próximo ano e o telefone.\n\nExemplo de resultado:\nMaria, 35 anos, 1.68m\nAno que vem: 36\nTelefone: 555-1234'
      },
...
print(f"Phone: {phone}")`,
    ...
    },
    {
      ...
      description: {
        en: 'Goal:\nWrite a gym membership calculator that applies a 10% advance-payment discount.\n\nProgram requirements\n\n1. Gather input\n- The member\'s name as text.\n- The monthly fee in dollars, allowing decimal values.\n- The number of months being paid, as a whole number.\n\n2. Calculate\n- The full price before the discount.\n- The amount saved with a 10% discount.\n- The final amount the member pays.\n\n3. Display\n- The member\'s name.\n- The full price, the amount saved and the final price.\n\nExample result:\nMember: Alex\nFull price: 480.0\n10% off saves: 48.0\nYou pay: 432.0',
        pt: 'Objetivo:\nEscreva uma calculadora de plano de academia que aplique 10% de desconto por pagamento antecipado.\n\nRequisitos do programa\n\n1. Receber os dados\n- O nome do aluno como texto.\n- A mensalidade em reais, permitindo valores decimais.\n- A quantidade de meses pagos, como número inteiro.\n\n2. Calcular\n- O preço cheio antes do desconto.\n- O valor economizado com 10% de desconto.\n- O valor final que o aluno pagará.\n\n3. Mostrar\n- O nome do aluno.\n- O preço cheio, o valor economizado e o preço final.\n\nExemplo de resultado:\nAluno: Alex\nPreço cheio: 480.0\n10% off economiza: 48.0\nVocê paga: 432.0'
      },
...
if damage ___ 5000 ___ days ___ 30:    # fill: >, and, <
    ...
    },
    {
      ...
      description: {
        en: 'Goal:\nWrite a cinema age checker that decides whether a person may watch an age-restricted film.\n\nProgram requirements\n\n1. Gather input\n- The person\'s age as a whole number.\n\n2. Decide\n- Allow people who are 18 or older.\n- Do not allow people who are younger than 18.\n\n3. Display\n- Show one clear message for the result that applies.\n\nExample result:\n🎬 Enjoy the movie!',
        pt: 'Objetivo:\nEscreva um verificador de idade do cinema que decida se a pessoa pode assistir a um filme com restrição etária.\n\nRequisitos do programa\n\n1. Receber os dados\n- A idade da pessoa como número inteiro.\n\n2. Decidir\n- Permita pessoas com 18 anos ou mais.\n- Não permita pessoas com menos de 18 anos.\n\n3. Mostrar\n- Mostre uma mensagem clara para o resultado aplicável.\n\nExemplo de resultado:\n🎬 Aproveite o filme!'
      },
...
if damage > 10000:
    ...
    },
    {
      ...
      description: {
        en: 'Goal:\nComplete the missing age brackets in a car-subscription fee calculator.\n\nProgram requirements\n\n1. Fill the brackets\n- Blank 1 completes the rule for drivers younger than 21.\n- Blank 2 completes the next bracket for drivers younger than 26.\n- Blank 3 provides the final catch-all branch for drivers not matched earlier.\n\n2. Verify\n- Age 25 must use the 1.6 multiplier.\n- Age 30 must use the 1.0 multiplier.\n- Age 70 must use the 1.5 multiplier.\n\nExample result:\nFee: 1600.0',
        pt: 'Objetivo:\nComplete as faixas de idade ausentes em uma calculadora de taxa de assinatura de automóvel.\n\nRequisitos do programa\n\n1. Preencher as faixas\n- A lacuna 1 completa a regra para motoristas com menos de 21 anos.\n- A lacuna 2 completa a faixa seguinte para motoristas com menos de 26 anos.\n- A lacuna 3 cria o caminho final para quem não se encaixou nas faixas anteriores.\n\n2. Conferir\n- A idade 25 deve usar o multiplicador 1,6.\n- A idade 30 deve usar o multiplicador 1,0.\n- A idade 70 deve usar o multiplicador 1,5.\n\nExemplo de resultado:\nFee: 1600.0'
      },
...
print("Fee:", fee)`,
    ...
    },
    {
      ...
      description: {
        en: 'Goal:\nWrite a movie-rating classifier that assigns one recommendation band from a whole-number score.\n\nProgram requirements\n\n1. Gather input\n- Ask for the movie score as a whole number.\n\n2. Classify\n- Check the highest band first, beginning at 90.\n- Use additional boundaries beginning at 75 and 60.\n- Ensure that exactly one recommendation band applies.\n\n3. Display\n- Show the recommendation message for the score.\n- A score in the top band must display the Highly Recommended message.\n\nExample result:\n👍 Highly Recommended',
        pt: 'Objetivo:\nEscreva um classificador de filmes que atribua uma única faixa de recomendação a partir de uma pontuação inteira.\n\nRequisitos do programa\n\n1. Receber os dados\n- Peça a pontuação do filme como número inteiro.\n\n2. Classificar\n- Verifique primeiro a faixa mais alta, começando em 90.\n- Use limites adicionais começando em 75 e 60.\n- Garanta que somente uma faixa de recomendação seja aplicada.\n\n3. Mostrar\n- Mostre a mensagem de recomendação correspondente à pontuação.\n- Uma pontuação na faixa mais alta deve mostrar a mensagem Muito Recomendado.\n\nExemplo de resultado:\n👍 Muito Recomendado'
      },
  ...
  exercises: [
    {
      ...
      description: {
        en: 'Goal:\nRun a completed while loop and trace how its counter controls the number of repetitions.\n\nProgram requirements\n\n1. Trace the original loop\n- Predict the five processed-order lines and the counter value after the loop ends.\n- Follow the counter from its starting value until the condition becomes false.\n\n2. Test a change\n- Change the upper limit from 5 to 3.\n- Predict how many processed lines will appear and the final counter value before running again.',
        pt: 'Objetivo:\nExecute um laço while completo e acompanhe como o contador controla a quantidade de repetições.\n\nRequisitos do programa\n\n1. Acompanhar o laço original\n- Preveja as cinco linhas de pedidos processados e o valor do contador após o fim do laço.\n- Acompanhe o contador desde o valor inicial até a condição se tornar falsa.\n\n2. Testar uma mudança\n- Troque o limite superior de 5 para 3.\n- Antes de executar novamente, preveja quantas linhas serão mostradas e o valor final do contador.'
      },
      starterCode: `count = 1
while count <= 5:
...
print("Final count value:", count)`,
    ...
    },
    {
      ...
      description: {
        en: 'Goal:\nComplete a coffee-shop stock countdown by replacing three blanks in the loop.\n\nProgram requirements\n\n1. Control the loop\n- Blank 1 keeps the loop running while at least 15 cups remain.\n\n2. Update each order\n- Blank 2 removes 15 cups from stock for each order.\n- Blank 3 advances the order number by one.\n\n3. Display\n- Show the remaining stock after every order and the restock message when the loop ends.\n\nExample result:\nOrder 1: 45 cups left\nOrder 2: 30 cups left\nOrder 3: 15 cups left\nOrder 4: 0 cups left\nRestock needed!',
        pt: 'Objetivo:\nComplete uma contagem regressiva de estoque de cafeteria substituindo três lacunas do laço.\n\nRequisitos do programa\n\n1. Controlar o laço\n- A lacuna 1 mantém o laço ativo enquanto houver pelo menos 15 copos.\n\n2. Atualizar cada pedido\n- A lacuna 2 retira 15 copos do estoque a cada pedido.\n- A lacuna 3 avança o número do pedido em uma unidade.\n\n3. Mostrar\n- Mostre o estoque restante após cada pedido e a mensagem de reposição quando o laço terminar.\n\nExemplo de resultado:\nOrder 1: 45 cups left\nOrder 2: 30 cups left\nOrder 3: 15 cups left\nOrder 4: 0 cups left\nRestock needed!'
      },
...
print("Restock needed!")`,
    ...
    },
    {
      ...
      description: {
        en: 'Goal:\nWrite a while-loop batch processor for four order amounts.\n\nProgram requirements\n\n1. Gather and process\n- Repeat exactly four times.\n- Receive one order amount during each repetition and add it to a running total.\n\n2. Calculate\n- After all four orders, calculate their average from the accumulated total.\n\n3. Display\n- Show the total of all four orders and their average.\n\nExample result:\nTotal: 10200\nAverage: 2550.0',
        pt: 'Objetivo:\nEscreva um processador em lote com while para quatro valores de pedidos.\n\nRequisitos do programa\n\n1. Receber e processar\n- Repita exatamente quatro vezes.\n- Receba um valor de pedido em cada repetição e adicione-o a um total acumulado.\n\n2. Calcular\n- Depois dos quatro pedidos, calcule a média usando o total acumulado.\n\n3. Mostrar\n- Mostre o total dos quatro pedidos e a média.\n\nExemplo de resultado:\nTotal: 10200\nAverage: 2550.0'
      },
  ...
  exercises: [
    {
      ...
      description: {
        en: 'Goal:\nRun a completed for loop and observe how it processes one list item per turn.\n\nProgram requirements\n\n1. Run and trace\n- Confirm the queue size and the order in which Alice, Bob and Carlos are processed.\n- Connect each loop turn to one name from the list.\n\n2. Change the list\n- Add Eva before the loop begins.\n- Predict the new queue size and whether Eva will be processed.\n\n3. Verify\n- Run again and confirm that the loop adapts to the larger list without changing the loop itself.',
        pt: 'Objetivo:\nExecute um laço for completo e observe como ele processa um item da lista por vez.\n\nRequisitos do programa\n\n1. Executar e acompanhar\n- Confirme o tamanho da fila e a ordem em que Alice, Bob e Carlos são processados.\n- Relacione cada repetição do laço com um nome da lista.\n\n2. Alterar a lista\n- Adicione Eva antes do início do laço.\n- Preveja o novo tamanho da fila e se Eva será processada.\n\n3. Conferir\n- Execute novamente e confirme que o laço se adapta à lista maior sem alterar o próprio laço.'
      },
...
print("Total:", total)`,
    ...
    },
    {
      ...
      description: {
        en: 'Goal:\nWrite a playlist analyzer for the provided song durations in seconds.\n\nProgram requirements\n\n1. Process the list\n- Use a loop to visit every song duration.\n- Accumulate the total listening time.\n- Count songs longer than four minutes, meaning more than 240 seconds.\n\n2. Calculate\n- Find the average song duration from the total and the number of songs.\n\n3. Display\n- Show the total time, the number of long songs and the average duration.\n\nExample result:\nTotal time: 1710 seconds\nLong songs (>4 min): 3\nAverage: 244.28571428571428 seconds',
        pt: 'Objetivo:\nEscreva um analisador de playlist para as durações fornecidas em segundos.\n\nRequisitos do programa\n\n1. Processar a lista\n- Use um laço para percorrer todas as durações.\n- Acumule o tempo total da playlist.\n- Conte as músicas com mais de quatro minutos, ou seja, acima de 240 segundos.\n\n2. Calcular\n- Calcule a duração média usando o total e a quantidade de músicas.\n\n3. Mostrar\n- Mostre o tempo total, a quantidade de músicas longas e a duração média.\n\nExemplo de resultado:\nTotal time: 1710 seconds\nLong songs (>4 min): 3\nAverage: 244.28571428571428 seconds'
      },
