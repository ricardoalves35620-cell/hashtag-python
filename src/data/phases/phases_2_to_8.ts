...
print("Final refund:", refund)`,
    ...
    },
    {
      ...
      description: {
        en: 'A music school has a yearly budget of $48,000. Split it across four categories and check the maths.\n\n**What to do**\n1. Store the yearly budget in a variable.\n2. Work out each category\'s share: materials 30%, teachers 45%, equipment 15%, admin 10%.\n3. Add the four shares together and show that the total matches the original budget.\n\n**Expected output**\nMaterials: 14400.0\nTeachers: 21600.0\nEquipment: 7200.0\nAdmin: 4800.0\nSum: 48000.0',
        pt: 'Uma escola de música tem um orçamento anual de R$48.000. Divida entre quatro categorias e confira a conta.\n\n**O que fazer**\n1. Guarde o orçamento anual numa variável.\n2. Calcule a parte de cada categoria: materiais 30%, professores 45%, equipamentos 15%, administração 10%.\n3. Some as quatro partes e mostre que o total bate com o orçamento original.\n\n**Saída esperada**\nMaterials: 14400.0\nTeachers: 21600.0\nEquipment: 7200.0\nAdmin: 4800.0\nSum: 48000.0'
      },
...
print(f"Phone: {phone}")`,
    ...
    },
    {
      ...
      description: {
        en: 'Write a gym membership calculator. The program asks a new member for their details and works out what they pay after a 10% advance-payment discount.\n\n**1. Gather input**\n• The member\'s name (text)\n• The monthly fee in dollars (decimals allowed)\n• How many months they are paying for (whole number)\n\n**2. Calculate**\n• The full price before any discount\n• A 10% discount on that full price\n• The final amount they actually pay\n\n**3. Display**\n• The member\'s name\n• The full price, the amount saved, and the final price\n\n**Example** — for Alex, 80.0 per month, 6 months:\nAluno: Alex\nPreço cheio: 480.0\n10% off economiza: 48.0\nVocê paga: 432.0',
        pt: 'Escreva uma calculadora de plano de academia. O programa pergunta os dados de um novo aluno e calcula quanto ele paga com 10% de desconto por pagamento antecipado.\n\n**1. Receber os dados**\n• O nome do aluno (texto)\n• A mensalidade em reais (pode ter decimais)\n• Quantos meses ele vai pagar (número inteiro)\n\n**2. Calcular**\n• O preço cheio, antes de qualquer desconto\n• Um desconto de 10% sobre esse preço cheio\n• O valor final que ele realmente paga\n\n**3. Mostrar**\n• O nome do aluno\n• O preço cheio, quanto economizou e o preço final\n\n**Exemplo** — para Alex, 80.0 por mês, 6 meses:\nAluno: Alex\nPreço cheio: 480.0\n10% off economiza: 48.0\nVocê paga: 432.0'
      },
...
if damage ___ 5000 ___ days ___ 30:    # fill: >, and, <
    ...
    },
    {
      ...
      description: {
        en: 'Write a cinema ticket checker. It asks for someone\'s age and tells them whether they can watch an age-restricted film.\n\n**1. Gather input**\n• The person\'s age, as a whole number\n\n**2. Decide**\n• 18 or over may watch\n• Under 18 may not\n\n**3. Display**\n• A clear message for whichever case applies\n\n**Example** — for age 20:\n🎬 Enjoy the movie!',
        pt: 'Escreva um verificador de ingresso de cinema. Ele pergunta a idade da pessoa e diz se ela pode assistir a um filme com classificação etária.\n\n**1. Receber os dados**\n• A idade da pessoa, como número inteiro\n\n**2. Decidir**\n• 18 anos ou mais pode assistir\n• Menos de 18 não pode\n\n**3. Mostrar**\n• Uma mensagem clara para o caso que se aplica\n\n**Exemplo** — para idade 20:\n🎬 Aproveite o filme!'
      },
...
print("Fee:", fee)`,
    ...
    },
    {
      ...
      description: {
        en: 'Write a delivery priority classifier. Given the value of an order, it decides how urgently the order should be handled.\n\n**1. Gather input**\n• The order value, in dollars\n\n**2. Classify into one band**\n• Above 8000 → CRITICAL\n• From 3000 to 8000 → URGENT\n• From 1000 to under 3000 → NORMAL\n• Below 1000 → LOW\n\n**3. Display**\n• The band the order falls into\n\nOnly one band can apply to any order — make sure the boundaries do not overlap.',
        pt: 'Escreva um classificador de prioridade de entrega. A partir do valor de um pedido, ele decide com que urgência o pedido deve ser tratado.\n\n**1. Receber os dados**\n• O valor do pedido, em reais\n\n**2. Classificar numa faixa**\n• Acima de 8000 → CRÍTICO\n• De 3000 a 8000 → URGENTE\n• De 1000 até menos de 3000 → NORMAL\n• Abaixo de 1000 → BAIXO\n\n**3. Mostrar**\n• A faixa em que o pedido se encaixa\n\nSó uma faixa pode valer para cada pedido — garanta que os limites não se sobreponham.'
      },
...
print("Restock needed!")`,
    ...
    },
    {
      ...
      description: {
        en: 'Write a savings countdown. Someone is putting money aside each week and wants to know how many weeks until they reach their goal.\n\n**1. Set up**\n• A starting balance of 0\n• A weekly deposit of 250\n• A goal of 1000\n\n**2. Repeat until the goal is reached**\n• Add one week\'s deposit\n• Count the week\n• Show the balance after each week\n\n**3. Finish**\n• Show how many weeks it took\n\nThe loop must stop on its own when the goal is reached — do not write the number of weeks by hand.',
        pt: 'Escreva uma contagem regressiva de poupança. Alguém guarda dinheiro toda semana e quer saber quantas semanas faltam até a meta.\n\n**1. Preparar**\n• Um saldo inicial de 0\n• Um depósito semanal de 250\n• Uma meta de 1000\n\n**2. Repetir até alcançar a meta**\n• Adicione o depósito de uma semana\n• Conte a semana\n• Mostre o saldo depois de cada semana\n\n**3. Encerrar**\n• Mostre quantas semanas levou\n\nO laço precisa parar sozinho ao alcançar a meta — não escreva o número de semanas à mão.'
      },
...
print("Total:", total)`,
    ...
    },
    {
      ...
      description: {
        en: 'Write a reading-list report. Given a list of book titles and how many pages each has, produce a short summary.\n\n**1. The data**\n• Titles: Dune, Solaris, Ubik\n• Pages: 412, 204, 224\n\n**2. For every book**\n• Show the title next to its page count\n\n**3. Summarise**\n• The total number of pages across all books\n• How many books are longer than 300 pages\n\nWork through the list with a loop — do not write each book out separately.',
        pt: 'Escreva um relatório de lista de leitura. Dada uma lista de títulos e quantas páginas cada um tem, produza um resumo curto.\n\n**1. Os dados**\n• Títulos: Dune, Solaris, Ubik\n• Páginas: 412, 204, 224\n\n**2. Para cada livro**\n• Mostre o título ao lado da quantidade de páginas\n\n**3. Resumir**\n• O total de páginas somando todos os livros\n• Quantos livros têm mais de 300 páginas\n\nPercorra a lista com um laço — não escreva cada livro separadamente.'
      },
