...
`,
    testCases: [
      ...
      { id: 'tc6_3', description: { en: 'Shows top student (highest grade)', pt: 'Mostra melhor aluno (nota mais alta)' }, inputs: [], checks: [{ type: 'contains_any', value: ['Top', 'top', 'Best', 'best', 'Max', 'max'] }], points: 10 },
      ...
      { id: 'tc6_5', description: { en: 'Shows list of passed students', pt: 'Mostra lista de aprovados' }, inputs: [], checks: [{ type: 'contains_any', value: ['Passed', 'passed', 'Pass', 'pass', 'PASS'] }], points: 10 },
      { id: 'tc6_6', description: { en: 'Shows top grade (95) in output', pt: 'Mostra nota mais alta (95) na saída' }, inputs: [], checks: [{ type: 'contains', value: '95' }], points: 10 },
      { id: 'tc6_7', description: { en: 'Shows a grade that passes (>= 70)', pt: 'Mostra nota aprovada (>= 70)' }, inputs: [], checks: [{ type: 'contains_any', value: ['72', '78', '88', '92', '95'] }], points: 10 },
