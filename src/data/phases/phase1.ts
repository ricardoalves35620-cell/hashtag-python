  ...
  exercises: [
    {
      ...
      description: {
        en: 'Goal:\nRun your first completed Python program and observe how it displays text, numbers and a calculation.\n\nProgram requirements\n\n1. Before running\n- Predict the order of the displayed lines and the age shown ten years later.\n\n2. Run and observe\n- Compare text values, numeric values, the calculated value and the blank line in the output.\n\n3. Personalize\n- Replace Alice with your own name, keep it as text, and run the program again.\n\nExample result:\nWelcome to Python!\nMy name is Alice\nMy age is 28\nIn 10 years I\'ll be 38\n\nThis is my first program!',
        pt: 'Objetivo:\nExecute seu primeiro programa Python completo e observe como ele mostra textos, números e um cálculo.\n\nRequisitos do programa\n\n1. Antes de executar\n- Preveja a ordem das linhas e a idade que será mostrada dez anos depois.\n\n2. Executar e observar\n- Compare os textos, os números, o valor calculado e a linha em branco na saída.\n\n3. Personalizar\n- Troque Alice pelo seu nome, mantenha-o como texto e execute novamente.\n\nExemplo de resultado:\nWelcome to Python!\nMy name is Alice\nMy age is 28\nIn 10 years I\'ll be 38\n\nThis is my first program!'
      },
...
print("This is my first program!")`,
    ...
    },
    {
      ...
      description: {
        en: 'Goal:\nComplete the MusicBox startup report by replacing the three blanks.\n\nProgram requirements\n\n1. Fill the blanks\n- Blank 1 is the application name as text.\n- Blank 2 is the whole-number count of new songs.\n- Blank 3 repeats that same song count so the program can combine it with the 12 new playlists.\n\n2. Display\n- Run the program and confirm that the startup report contains the app name, both counts and their total.\n\nExample result:\n=== SYSTEM START ===\nApp: MusicBox\nNew songs: 47\nNew playlists: 12\nTotal: 59',
        pt: 'Objetivo:\nComplete o relatório de inicialização do MusicBox substituindo as três lacunas.\n\nRequisitos do programa\n\n1. Preencher as lacunas\n- A lacuna 1 é o nome do aplicativo como texto.\n- A lacuna 2 é a quantidade inteira de músicas novas.\n- A lacuna 3 repete essa mesma quantidade para que o programa a combine com as 12 playlists novas.\n\n2. Mostrar\n- Execute o programa e confirme que o relatório contém o nome do app, as duas quantidades e o total.\n\nExemplo de resultado:\n=== SYSTEM START ===\nApp: MusicBox\nNew songs: 47\nNew playlists: 12\nTotal: 59'
      },
...
print("Total:", ___ + 12)       # fill: 47 again (same number as line 3)`,
    ...
    },
    {
      ...
      description: {
        en: 'Goal:\nWrite a coffee-shop report that uses Python to calculate the revenue from 80 coffees sold at 5 dollars each.\n\nProgram requirements\n\n1. Calculate\n- Work out the total revenue from the number sold and the price of each coffee.\n\n2. Display\n- Show the report title.\n- Show the number of coffees sold and the price per coffee.\n- Show the calculated total revenue.\n- Finish with the completion message.\n\nExample result:\n--- COFFEE SHOP REPORT ---\nCoffees sold: 80\nPrice per coffee: 5\nTotal revenue: 400\nReport complete!',
        pt: 'Objetivo:\nEscreva um relatório de cafeteria que use Python para calcular a receita de 80 cafés vendidos a 5 reais cada.\n\nRequisitos do programa\n\n1. Calcular\n- Calcule a receita total usando a quantidade vendida e o preço de cada café.\n\n2. Mostrar\n- Mostre o título do relatório.\n- Mostre a quantidade de cafés vendidos e o preço por café.\n- Mostre a receita total calculada.\n- Finalize com a mensagem de conclusão.\n\nExemplo de resultado:\n--- COFFEE SHOP REPORT ---\nCoffees sold: 80\nPrice per coffee: 5\nTotal revenue: 400\nReport complete!'
      },
