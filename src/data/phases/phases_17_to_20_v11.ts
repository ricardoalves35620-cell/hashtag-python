...
export const phase17: Phase = {
  ...
  exercises: [
    ...
    makeExercise({
      ...
      description: b('Goal:\nComplete parse_stock(text).\n\nProgram requirements\n\n1. Build the result\n- Return dictionaries.\n\n2. Validate\n- Each non-empty row is sku|name|quantity.\n- Reject negative quantities.\n\n3. Verify\n- Return the requested value in the required shape.\n- Test with the provided example and at least one different valid case.\n\nExample result:\n[{\'sku\': \'A1\', \'name\': \'Café\', \'quantity\': 3}, {\'sku\': \'B2\', \'name\': \'Rice\', \'quantity\': 10}]', 'Objetivo:\nComplete parse_stock(text).\n\nRequisitos do programa\n\n1. Montar o resultado\n- Retorne dicionários.\n\n2. Validar\n- Cada linha não vazia é sku|name|quantity.\n- Rejeite quantidades negativas.\n\n3. Conferir\n- Retorne o valor solicitado no formato exigido.\n- Teste com o exemplo fornecido e pelo menos um caso válido diferente.\n\nExemplo de resultado:\n[{\'sku\': \'A1\', \'name\': \'Café\', \'quantity\': 3}, {\'sku\': \'B2\', \'name\': \'Rice\', \'quantity\': 10}]'),
    ...
    makeExercise({
      ...
      description: b('Goal:\nCreate read_nonempty(path).\n\nProgram requirements\n\n1. Build the result\n- Open the file safely as UTF-8.\n- Do not print inside the function.\n\n2. Validate\n- Return stripped non-empty lines.\n\n3. Verify\n- Return the requested value in the required shape.\n- Test with the provided example and at least one different valid case.\n\nExample result:\n[\'alpha\', \'ação\', \'omega\']', 'Objetivo:\nCrie read_nonempty(path).\n\nRequisitos do programa\n\n1. Montar o resultado\n- Abra o arquivo com segurança em UTF-8.\n- Não imprima dentro da função.\n\n2. Validar\n- Retorne linhas não vazias sem espaços externos.\n\n3. Conferir\n- Retorne o valor solicitado no formato exigido.\n- Teste com o exemplo fornecido e pelo menos um caso válido diferente.\n\nExemplo de resultado:\n[\'alpha\', \'ação\', \'omega\']'),
...
export const phase18: Phase = {
  ...
  exercises: [
    makeExercise({
      ...
      description: b('Goal:\nImplement format_report(title, rows).\n\nProgram requirements\n\n1. Build the result\n- Trim the title, add it first and add every row as \'key=value\'.\n- Return one string ending with a newline.\n\n2. Verify\n- Return the requested value in the required shape.\n- Test with the provided example and at least one different valid case.\n\nExample result:\nStock\ncoffee=3\ntea=8', 'Objetivo:\nImplemente format_report(title, rows).\n\nRequisitos do programa\n\n1. Montar o resultado\n- Limpe o título, coloque primeiro e adicione cada linha como \'chave=valor\'.\n- Retorne string terminando em quebra.\n\n2. Conferir\n- Retorne o valor solicitado no formato exigido.\n- Teste com o exemplo fornecido e pelo menos um caso válido diferente.\n\nExemplo de resultado:\nEstoque\ncafé=3\nchá=8'),
    ...
    makeExercise({
      ...
      description: b('Goal:\nComplete save_lines(path, lines).\n\nProgram requirements\n\n1. Build the result\n- Replace the destination, write each item as text followed by one newline.\n- Return the number written.\n\n2. Verify\n- Return the requested value in the required shape.\n- Test with the provided example and at least one different valid case.\n\nExample result:\n3\nalpha\nação\n99', 'Objetivo:\nComplete save_lines(path, lines).\n\nRequisitos do programa\n\n1. Montar o resultado\n- Substitua o destino, escreva cada item como texto seguido de uma quebra.\n- Retorne a quantidade.\n\n2. Conferir\n- Retorne o valor solicitado no formato exigido.\n- Teste com o exemplo fornecido e pelo menos um caso válido diferente.\n\nExemplo de resultado:\n3\nalpha\nação\n99'),
    ...
    makeExercise({
      ...
      description: b('Goal:\nCreate export_products(path, products).\n\nProgram requirements\n\n1. Build the result\n- Write a header and products sorted by sku.\n- Return the number of data rows.\n\n2. Validate\n- Reject negative quantity.\n\n3. Verify\n- Return the requested value in the required shape.\n- Test with the provided example and at least one different valid case.\n\nExample result:\n2\nsku,name,quantity\nA1,"Café, premium",4\nB2,Tea,10', 'Objetivo:\nCrie export_products(path, products).\n\nRequisitos do programa\n\n1. Montar o resultado\n- Escreva cabeçalho e produtos ordenados por sku.\n- Retorne o número de dados.\n\n2. Validar\n- Rejeite quantidade negativa.\n\n3. Conferir\n- Retorne o valor solicitado no formato exigido.\n- Teste com o exemplo fornecido e pelo menos um caso válido diferente.\n\nExemplo de resultado:\n2\nsku,name,quantity\nA1,"Café, premium",4\nB2,Tea,10'),
...
export const phase19: Phase = {
  ...
  exercises: [
    makeExercise({
      ...
      description: b('Goal:\nImplement decode_profile(text).\n\nProgram requirements\n\n1. Build the result\n- Return a new dictionary.\n\n2. Validate\n- Parse a JSON object, require a non-empty string name, default tags to [], normalize tags to sorted unique lowercase strings.\n\n3. Verify\n- Return the requested value in the required shape.\n- Test with the provided example and at least one different valid case.\n\nExample result:\n{\'name\': \'Lia\', \'tags\': [\'dados\', \'python\']}', 'Objetivo:\nImplemente decode_profile(text).\n\nRequisitos do programa\n\n1. Montar o resultado\n- Retorne novo dicionário.\n\n2. Validar\n- Interprete objeto JSON, exija name não vazio, use [] como padrão de tags, normalize tags para strings minúsculas únicas e ordenadas.\n\n3. Conferir\n- Retorne o valor solicitado no formato exigido.\n- Teste com o exemplo fornecido e pelo menos um caso válido diferente.\n\nExemplo de resultado:\n{\'name\': \'Lia\', \'tags\': [\'dados\', \'python\']}'),
    ...
    makeExercise({
      ...
      description: b('Goal:\nComplete encode_settings(settings).\n\nProgram requirements\n\n1. Build the result\n- Require a dictionary.\n- Return compact deterministic JSON that preserves Unicode, sorts keys and omits unnecessary spaces.\n\n2. Verify\n- Return the requested value in the required shape.\n- Test with the provided example and at least one different valid case.\n\nExample result:\n{"language":"pt-BR","theme":"escuro"}', 'Objetivo:\nComplete encode_settings(settings).\n\nRequisitos do programa\n\n1. Montar o resultado\n- Exija um dicionário.\n- Retorne JSON compacto e determinístico, preservando Unicode, ordenando as chaves e removendo espaços desnecessários.\n\n2. Conferir\n- Retorne o valor solicitado no formato exigido.\n- Teste com o exemplo fornecido e pelo menos um caso válido diferente.\n\nExemplo de resultado:\n{"language":"pt-BR","theme":"escuro"}'),
    ...
    makeExercise({
      ...
      description: b('Goal:\nCreate order_total(text).\n\nProgram requirements\n\n1. Build the result\n- Parse a JSON array of items with numeric price and non-negative integer quantity.\n- Return the rounded total.\n\n2. Validate\n- Reject invalid items.\n\n3. Verify\n- Return the requested value in the required shape.\n- Test with the provided example and at least one different valid case.\n\nExample result:\n25.5', 'Objetivo:\nCrie order_total(text).\n\nRequisitos do programa\n\n1. Montar o resultado\n- Interprete array JSON de itens com price numérico e quantity inteiro não negativo.\n- Retorne total arredondado.\n\n2. Validar\n- Rejeite itens inválidos.\n\n3. Conferir\n- Retorne o valor solicitado no formato exigido.\n- Teste com o exemplo fornecido e pelo menos um caso válido diferente.\n\nExemplo de resultado:\n25.5'),
...
export const phase20: Phase = {
  ...
  exercises: [
    makeExercise({
      ...
      description: b('Goal:\nImplement days_between(start, end).\n\nProgram requirements\n\n1. Build the result\n- Interpret both YYYY-MM-DD values as dates.\n- Return the number of whole days from start to end.\n\n2. Verify\n- Return the requested value in the required shape.\n- Test with the provided example and at least one different valid case.\n\nExample result:\n10', 'Objetivo:\nImplemente days_between(start, end).\n\nRequisitos do programa\n\n1. Montar o resultado\n- Interprete os dois valores YYYY-MM-DD como datas.\n- Retorne a quantidade de dias inteiros entre o início e o fim.\n\n2. Conferir\n- Retorne o valor solicitado no formato exigido.\n- Teste com o exemplo fornecido e pelo menos um caso válido diferente.\n\nExemplo de resultado:\n10'),
    ...
    makeExercise({
      ...
      description: b('Goal:\nComplete due_date(start, days).\n\nProgram requirements\n\n1. Build the result\n- Move forward by the requested number of days.\n- Return the resulting date as ISO text.\n\n2. Validate\n- Reject a negative day count.\n\n3. Verify\n- Return the requested value in the required shape.\n- Test with the provided example and at least one different valid case.\n\nExample result:\n2027-01-03', 'Objetivo:\nComplete due_date(start, days).\n\nRequisitos do programa\n\n1. Montar o resultado\n- Avance a data pelo período solicitado.\n- Retorne a data resultante em formato ISO.\n\n2. Validar\n- Rejeite uma quantidade negativa de dias.\n\n3. Conferir\n- Retorne o valor solicitado no formato exigido.\n- Teste com o exemplo fornecido e pelo menos um caso válido diferente.\n\nExemplo de resultado:\n2027-01-03'),
    ...
    makeExercise({
      ...
      description: b('Goal:\nCreate deadline_status(opened, today, limit).\n\nProgram requirements\n\n1. Build the result\n- Return \'overdue:N\' when the age exceeds the limit.\n- Otherwise return \'on-time:N\'.\n\n2. Validate\n- Reject future opened dates.\n\n3. Verify\n- Return the requested value in the required shape.\n- Test with the provided example and at least one different valid case.\n\nExample result:\noverdue:10', 'Objetivo:\nCrie deadline_status(opened, today, limit).\n\nRequisitos do programa\n\n1. Montar o resultado\n- Retorne \'overdue:N\' quando a idade ultrapassar o limite; caso contrário.\n- Retorne \'on-time:N\'.\n\n2. Validar\n- Rejeite abertura futura.\n\n3. Conferir\n- Retorne o valor solicitado no formato exigido.\n- Teste com o exemplo fornecido e pelo menos um caso válido diferente.\n\nExemplo de resultado:\noverdue:10'),
