...
export const phase0: Phase = {
  ...
  exercises: [
    {
      ...
      hints: [{ en: 'Run it without changing anything first.', pt: 'Primeiro execute sem alterar nada.' }],
  ...
  quiz: [
    { id: 'q0-1', question: { en: 'Which filename identifies Python code?', pt: 'Qual nome identifica código Python?' }, options: [{ en: 'app.txt', pt: 'app.txt' }, { en: 'app.py', pt: 'app.py' }, { en: 'app.zip', pt: 'app.zip' }], correctIndex: 1, explanation: { en: '.py is the Python file extension.', pt: '.py é a extensão dos arquivos Python.' } },
    { id: 'q0-2', question: { en: 'What is a folder for?', pt: 'Para que serve uma pasta?' }, options: [{ en: 'Organizing files and other folders', pt: 'Organizar arquivos e outras pastas' }, { en: 'Increasing internet speed', pt: 'Aumentar a velocidade da internet' }, { en: 'Replacing RAM', pt: 'Substituir a RAM' }], correctIndex: 0, explanation: { en: 'Folders organize items and make paths predictable.', pt: 'Pastas organizam itens e deixam os caminhos previsíveis.' } },
    { id: 'q0-3', question: { en: 'Which resource stores temporary working data?', pt: 'Qual recurso guarda dados temporários de trabalho?' }, options: [{ en: 'RAM', pt: 'RAM' }, { en: 'Storage', pt: 'Armazenamento' }, { en: 'Folder', pt: 'Pasta' }], correctIndex: 0, explanation: { en: 'RAM is fast temporary memory used by open programs.', pt: 'RAM é a memória temporária rápida usada por programas abertos.' } },
    { id: 'q0-4', question: { en: 'What does local execution mean?', pt: 'O que significa execução local?' }, options: [{ en: 'The work runs on your device', pt: 'O trabalho executa no seu dispositivo' }, { en: 'The work always needs a paid API', pt: 'O trabalho sempre precisa de API paga' }, { en: 'The file has no location', pt: 'O arquivo não tem localização' }], correctIndex: 0, explanation: { en: 'Local software uses your own machine instead of a remote service.', pt: 'Software local usa sua própria máquina em vez de um serviço remoto.' } },
    { id: 'q0-5', question: { en: 'What does python --version do?', pt: 'O que python --version faz?' }, options: [{ en: 'Shows the installed Python version', pt: 'Mostra a versão instalada do Python' }, { en: 'Deletes Python', pt: 'Apaga o Python' }, { en: 'Creates a cloud account', pt: 'Cria uma conta na nuvem' }], correctIndex: 0, explanation: { en: 'It is a safe information command.', pt: 'É um comando seguro de consulta.' } },
  ],
  exam: {
